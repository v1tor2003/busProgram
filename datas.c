...
// Incrementa em um dia a data d
{
    ...
    if (d.dia < max_dias[d.mes-1]) // Incrementa s� precisa mudar o dia. Os meses e anos continuam inalterados.
    {
        novo_d.dia = d.dia+1;
        novo_d.mes = d.mes;
        novo_d.ano = d.ano;
    ...
    {
        if (d.mes < max_meses) // Al�m do dia, o m�s � alterado para o pr�ximo m�s pois chegou ao fim.
        {
            novo_d.dia = 1;
            novo_d.mes = d.mes+1;
            novo_d.ano = d.ano;
